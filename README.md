...
Mijot est distribué sous licence MIT. Cette licence couvre le code source, la documentation, le nom « Mijot », le logo et les éléments graphiques originaux du dépôt. Consultez le fichier [LICENSE](LICENSE).
